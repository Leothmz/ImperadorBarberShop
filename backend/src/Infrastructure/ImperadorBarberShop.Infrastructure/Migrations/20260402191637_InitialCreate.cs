    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1000000-0000-0000-0000-000000000001"), "Corte moderno e estiloso", 30, true, "Corte de Cabelo", 35.00m },
                    { new Guid("a1000000-0000-0000-0000-000000000002"), "Aparar e modelar a barba", 20, true, "Barba", 25.00m },
                    { new Guid("a1000000-0000-0000-0000-000000000003"), "Corte de cabelo e barba completo", 50, true, "Corte + Barba", 55.00m },
                    { new Guid("a1000000-0000-0000-0000-000000000004"), "Corte para crianças até 12 anos", 25, true, "Corte Infantil", 28.00m },
                    { new Guid("a1000000-0000-0000-0000-000000000005"), "Modelagem de sobrancelha masculina", 15, true, "Sobrancelha", 18.00m },
                    { new Guid("a1000000-0000-0000-0000-000000000006"), "Barba completa com navalha quente", 30, true, "Navalhada", 40.00m }
                });
